...
public class SwitcherRestartCommand extends Command {
    public SwitcherRestartCommand() {
        super("swiRestart".toLowerCase());
        setUsage("CraftSwitcher server restart command");
    }
